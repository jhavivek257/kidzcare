                        ...
                        <div class="product__big__images">
                            <div class="portfolio-full-image tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                    <img src="<?php echo PRODUCT_IMAGE_SITE_PATH . $get_product['0']['image'] ?>" height="400px" width="350px">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <form action="" method="post">
                                            ...
                                            <div class="text-right mtb--10">
                                                <button class="btn btn-success btn-lg fv-btn" type="submit" name="review_submit">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
