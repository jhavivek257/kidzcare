                        ...
                        <div class="row align-items__center">
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        ?>
                                            <div class="cr__btn">
                                                <a href="<?php echo $rowBanner['btn_link'] ?>" class="fr__btn"><?php echo $rowBanner['btn_txt'] ?></a>
                                            </div>
                                        <?php
                                        }
                                        ?>
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="<?php echo BANNER_SITE_PATH . $rowBanner['image'] ?>" height="250px" width="560px">
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="ftr__product__area ptb--40">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="section__title--2 text-center">
                    <h2 class="title__line">Most Loved by Moms💕</h2>
                </div>
            </div>
        </div>
        <div class="row">
