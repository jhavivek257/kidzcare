                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
											...
											?>
                                            <tr>
												<td class="product-name" style="font-size: 12px;"><?php echo $row['name']?></td>
                                                <td class="product-name"> <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$row['image']?>" height="50px" width="50px"></td>
